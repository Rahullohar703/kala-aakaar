...
const Testimonials = () => {
  ...
  const testimonials = [
    {
      quote: 'I had the pleasure of working with kalaaakaar, and I cannot express how impressed and grateful I am for the incredible work they did. From start to finish, the team was attentive, knowledgeable, and creative.',
      author: 'Sneha Singhi',
      location: 'Pune',
    },
    {
      quote: 'kalaaakaar understood our vision from the very first meeting. The attention to detail and the seamless execution made the entire journey effortless. Our home feels like a true reflection of who we are.',
    ...
    {
      quote: 'Working with Kala Aakaar was a transformative experience. They turned our outdated apartment into a modern sanctuary while respecting our budget and timeline. Truly exceptional service.',
    ...
    {
      quote: 'Kala Aakaar transformed our commercial space into something our clients love. The design perfectly balances professionalism with warmth. Best investment we made for our business.',
      author: 'Vishal Joshi',
  ...
  return (
    <section className="section-padding bg-background border-t border-border overflow-hidden">
      <div ref={ref} className="relative">
        {/* Section Header */}
        <div className={`text-center mb-12 md:mb-16 container-luxury transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        <div className={`relative mb-6 transition-all duration-700 delay-100 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
...
const TestimonialCard = ({ testimonial }: { testimonial: { quote: string; author: string; location: string } }) => {
  return (
    <div className="flex-shrink-0 w-[320px] md:w-[400px] mx-3 group">
      <div className="bg-card/30 backdrop-blur-sm border border-border/50 p-6 md:p-8 h-full hover:border-champagne/30 transition-all duration-500">
        ...
        <p className="font-cormorant text-sm md:text-base text-foreground/80 leading-relaxed mb-6 line-clamp-4">
          {testimonial.quote}
        </p>
